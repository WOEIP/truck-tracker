  ...
  render() {
    return (
      <article id="about-text">
        ...
        <span className="image main"><img src={aerial} alt="aerial view of abnadoned 16th Street train depot in West Oakland" /></span>
        ...
        <p>The Truck tracker tool is a project of the West Oakland Environmental Indicators Project. WOEIP is a resident led, community-based environmental justice organization dedicated to achieving healthy homes, healthy jobs, and healthy neighborhoods for all who live, work, learn, and play in West Oakland, California. Built by Attila Motching with support from OpenOakland volunteers, we hope to continue expanding the tool so it can be adopted by other communities. We welcome <a className="textlink" href"#contributing">contributions</a> of all kinds.</p>
