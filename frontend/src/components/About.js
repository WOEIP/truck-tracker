  ...
  render() {
    return (
      <article id="about-text">
        ...
        <p><b>Truck Tracker enables West Oakland residents to monitor truck traffic, so we can better understand the impact of trucking emissions on our community, hold violators accountable, and advocate for better air.</b></p>
        <span className="image main"><img src={mural} alt="aerial view of abnadoned 16th Street train depot in West Oakland" /></span>
        ...
        <p>The Truck Tracker tool is a project of the <a className="textlink" href="https://woeip.org">West Oakland Environmental Indicators Project</a>. WOEIP is a resident led, community-based environmental justice organization dedicated to achieving healthy homes, healthy jobs, and healthy neighborhoods for all who live, work, learn, and play in West Oakland, California. Built by <a className="textlink" href="https://github.com/motching">Attila Motching</a> with support from <a className="textlink" href="https://openoakland.org">OpenOakland</a> volunteers, we hope to continue expanding the tool so it can be adopted by other communities. We welcome <a className="textlink" href="#contributing">contributions</a> of all kinds.</p>
